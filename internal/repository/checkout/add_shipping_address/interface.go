...
// internal/repository/checkout/add_shipping_address/interface.go
...
type AddShippingAddressRepoInterface interface {
	...
	MarkCheckoutSessionReadyToOrder(ctx context.Context, arg sqlc.MarkCheckoutSessionReadyToOrderParams) (uuid.UUID, error)
}

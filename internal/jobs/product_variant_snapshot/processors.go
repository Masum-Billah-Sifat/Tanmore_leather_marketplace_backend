...
func processProductCategoryUpdated(
	...
	return q.UpdateCategoryInProductVariantSnapshots(ctx, sqlc.UpdateCategoryInProductVariantSnapshotsParams{
...
func processProductArchived(
	...
	return q.MarkProductArchivedInProductVariantSnapshots(ctx, sqlc.MarkProductArchivedInProductVariantSnapshotsParams{
		Updatedat: timeutil.NowUTC(),
		Productid: event.ProductID,
	})
}
